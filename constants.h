...
#define MATRIX_ACCESS_ADRESSING 2
...
#define LENGTH_OF_BASE4_WORD 5
#define LENGTH_OF_BASE4_ADDRESS 4
#define MATRIX_ADDRESSING_SUFFIX_LENGTH 8
#define MACRO_DEF_STRING "mcro"
