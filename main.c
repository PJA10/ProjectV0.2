...
const command commands[NUM_OF_COMMAND_TYPES + 1] = { /*a array to store all the functions names and id for identification*/
        ...
        {"cmp",     CMP, {IMMEDIATE_ADDRESSING,DIRECT_ADDRESSING,STRUCT_ACCESS_ADRESSING,REGISTERS_ADDRESSING}, {IMMEDIATE_ADDRESSING,DIRECT_ADDRESSING,STRUCT_ACCESS_ADRESSING,REGISTERS_ADDRESSING}},
